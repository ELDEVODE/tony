  ...
  return (
    <div className="p-8 flex flex-col justify-center items-center CFont">
      <div className="flex flex-col items-center justify-start h-scren mt-20 glass p-4 max-w-lg rounded-2xl">
        ...
        {/* <p className="text-2xl CFont text-[#d71214] font-bold text-center max-w-3xl">
      ...
      <div>
        ...
        <div
          id="About us"
          className="flex flex-col items-center justify-start h-scren mt-20  p-4 max-w-3xl rounded-2xl border-[10px] border-red-600 shadow-2xl rounded-bl-[100px]"
        >
          <h1 className="text-7xl md:text-[100px] CFont text-[#d71214] font-bold text-center mb-4">
            About Tony
          </h1>
          <p className="text-2xl CFont text-[#d71214] font-bold text-center max-w-3xl">
